<?php require_once('Connections/medi.php'); ?>
<?php
...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  $insertSQL = sprintf("INSERT INTO register (username, id, email, phone, password) VALUES (%s, %s, %s, %s, %s)",
  ...
  mysql_select_db($database_medi, $medi);
  $Result1 = mysql_query($insertSQL, $medi) or die(mysql_error());
...
<body>
            ...
            <div class="topbar-wrap">
                <div class="topbar-left">
                    <span>
                        ...
                        <span>Gatanga, Murang'a, KENYA</span>
                    </span>
    ...
    <header class="header">
        <div class="container">
           <nav class="navbar navbar-expand-lg">
              <a class="navbar-brand" href="#"><img src="media/common/logo.png" alt=""></a>
              ...
              <div class="collapse navbar-collapse" id="navbar-content">
                 <ul class="navbar-nav ms-auto">
                    ...
                    <li class="nav-item">
                       <a class="nav-link" href="services.html">our services</a>                    </li>
                    <li class="nav-item">
                    ...
                    <li class="nav-item nav-button">
                       <a class="nav-link" href="appointment.php">Appointment</a>                    </li>
                 </ul>
              </div>
           </nav>
        </div>
    ...
    <section class="appoinment-page">
        <div class="container">
            <div class="form-wrap">
                <div class="mb-4">
                    <input type="text" id="appoinment_username" placeholder="Your Username" name="username">
                </div>
                <div class="mb-4">
                    <input type="number" id="appoinment_id" placeholder="Your ID Number" name="ID">
                </div>
				  <div class="mb-4">
                    <input type="email" id="appoinment_email" placeholder="Your Email" name="email">
                </div>
                <div class="mb-4">
                    <input type="number" id="appoinment_number" placeholder="Your Phone Number" name="phone">
                </div>
				  <div class="mb-4">
                    <input type="text" id="appoinment_password" placeholder="Password" name="password">
                </div>
				 ...
				 <br>
								<div class="text-center">
				<a href="login.php" class="appoinment-btn">Login</a>
            ...
            <div class="row gy-4 footer-content">
                <div class="col-lg-3">
                    <div class="footer-widget-1">
                        <a href="#">
                            <img class="img-fluid" src="media/common/logo.png" alt="">
                        </a>
                            ...
                            <li class="item">
                                <a href="#">
                                    ...
                                    <span>
                                        ...
                                        marzleytechsolutions@gmail.com
                                    </span>
                                </a>
                            </li>
                            <li class="item">
...
<script src="assets/js/parallax100.js"></script>
