...
if (isset($_POST['username'])) {
  ...
  $LoginRS = mysql_query($LoginRS__query, $medi) or die(mysql_error());
            ...
            <div class="col-xs-12">
                <div class="breadcrumb-content">
                    <div class="breadcrumb-text-wrapper">
                        <h2 class="page-name">Welcome back</h2>
        ...
        <div class="container">
            <div class="form-wrap">
		  	 ...
		  	 <div class="text-center">
                     <button class="appoinment-btn" style="background: #66FFCC">submit to login</button>
                 </div>
                 </div>
 </div>
